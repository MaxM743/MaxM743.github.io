...
class Complex{
  ...
  class Widgets{
    constructor(){
      ...
      this.buttonReset.parent('mandelbrot-widgets'); 
      this.buttonBack.parent('mandelbrot-widgets');
      this.selectIterations.thousand.parent('mandelbrot-widgets');
      this.selectIterations.hundred.parent('mandelbrot-widgets');
      this.selectIterations.ten.parent('mandelbrot-widgets');
      this.selectIterations.one.parent('mandelbrot-widgets');
