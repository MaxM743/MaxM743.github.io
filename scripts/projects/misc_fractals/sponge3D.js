...
function sponge(x, y, z, length, level){
  if (level == maximum2){
    ...
    //sponge(x+length/3, y, z + length/3, length/3, level+1);
    sponge(x+2*length/3, y, z + length/3, length/3, level+1);
    
    //sponge(x, y+length/3, z+length/3, length/3, level+1);

    //sponge(x+2*length/3, y+length/3, z+length/3, length/3, level+1);
    
    sponge(x, y+2*length/3, z+length/3, length/3, level+1);
    //sponge(x+length/3, y+2*length/3, z+length/3, length/3, level+1);
